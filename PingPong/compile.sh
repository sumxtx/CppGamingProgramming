...
g++ -c Bat.cpp main.cpp -I../../SFML-2.6.0/include
g++ Bat.o main.o -o Bat-app -L../../SFML-2.6.0/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio ../../SFML-2.6.0/lib/libFLAC.so.12
